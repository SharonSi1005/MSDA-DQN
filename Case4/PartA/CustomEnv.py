...
class DynChgEnv(gym.Env):
    ...
    def __init__(self, n_DWERs=12, n_nodes=41, chgNodes=None, allNodes=None, df=None,
                 EnableBlockWCLs=False, EnableDynPrices=False, EnableTollGPLs=False):
        super().__init__()
        ...
        self.EnableBlockWCLs = EnableBlockWCLs
        self.EnableDynPrices = EnableDynPrices
        self.EnableTollGPLs = EnableTollGPLs
    ...
    def reset(self, seed=None, options=None):
        ...
        Ctr, L, Cch = utils.getFeatures(
            ...
            G_length_adj_matrix,
            G_eqv_adj_matrix,
            EnableBlockWCLs=self.EnableBlockWCLs,
            EnableDynPrices=self.EnableDynPrices,
            EnableTollGPLs=self.EnableTollGPLs,
